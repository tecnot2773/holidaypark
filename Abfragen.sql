...
use holiday_park;
SELECT vehicle.vehicle_id, vc.cart_nr FROM vehicle
...
/* Alle Gebäude die child friendly oder tiere erlauben sind und nicht reserviert sind */
use holiday_park;
...
/* Alle Checkouts wo die key card nicht zurück gegeben wurde und schon länger als 10 Tage abgereist ist */
use holiday_park;
...
use holiday_park;
SELECT * FROM is_lent_to_at_checkin